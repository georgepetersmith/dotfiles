local default_colorscheme = "default_theme"
local user_colorscheme = "default_theme"
if not vim.tbl_contains(vim.fn.getcompletion("", "color"), user_colorscheme) then
  user_colorscheme = default_colorscheme
end
vim.api.nvim_command(("colorscheme %s"):format(user_colorscheme))
