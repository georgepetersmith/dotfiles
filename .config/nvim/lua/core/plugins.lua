...
local packer = gnvim.initialize_packer()
packer.startup {
  function(use)
    for key, plugin in pairs(gnvim_plugins) do
  ...
  config = {
    compile_path = gnvim.default_compile_path,
    display = {
      open_fn = function()
